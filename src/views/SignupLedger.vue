...
export default class SignupLedger extends Vue {
    ...
    private created() {
        ...
        this._run();
        LazyLoading.loadNimiq(true); // already kick off Nimiq wasm import to be ready in _calculateWalletId
    }
    ...
    private async _calculateWalletId(): Promise<string> {
        ...
        await LazyLoading.loadNimiq(true); // load wasm to be able to compute hash
